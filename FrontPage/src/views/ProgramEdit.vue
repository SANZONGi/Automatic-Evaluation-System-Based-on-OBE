            ...
            <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}">
              <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
                ...
                <el-form-item label="培养方案名称" label-width="100px">
                  <el-input v-model="formLabelAlign.name" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="适用年级" label-width="100px">
                  <el-input v-model="formLabelAlign.grad" style="width: 150px"></el-input>
                </el-form-item>
